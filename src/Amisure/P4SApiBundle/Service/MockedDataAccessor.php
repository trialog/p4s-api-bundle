...
use Amisure\Service1Bundle\Entity\Event;
use Amisure\Service1Bundle\Entity\Evaluation;
use Amisure\Service1Bundle\DataFixtures\EvaluationsFixture;
use Amisure\Service1Bundle\Entity\Role;
use Amisure\Service1Bundle\Entity\Organization;
...
class MockedDataAccessor extends ADataAccessor
{
	...
	public function __construct()
	{
		...
		$this->evaluation1 = EvaluationsFixture::createDefaultMockedEvaluation($this->evaluation1);
		...
		$this->evaluation2 = EvaluationsFixture::createDefaultMockedEvaluation($this->evaluation2);
